...
const translations: Record<Locale, Record<string, string>> = {
	en: {
		...
		"settings.ragEmbeddingNote": "Embedding-based semantic search will be available in a future update (Phase 2).",
	...
	ja: {
		...
		"settings.ragEmbeddingNote": "Embeddingベースのセマンティック検索は今後のアップデート（Phase 2）で利用可能になります。",
